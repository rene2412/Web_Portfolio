...
const projects = [
  {
    ...
    media: [
         ...
         { type: 'image', url: '/curl.png'},
         { type: 'image', url: '/networking.png' }
    ]
  },
  {
    id: 3,
    title: "Super Mario Bros Clone (C++)",
    description: "A C++ Super Mario Bros clone using the Raylib graphics API with collision detection, object management, and multi-threaded performance optimizations. Showcases object-oriented, polymorphism, parallel processing, and smart pointers",
    tags: ["C++", "Raylib", "Open MP", "Linux", "Git"],
    year: "2025",
  ...
  },
  {
    ...
    description: "A complete blackjack game engine in C++ handling player/dealer logic, split hands, bets, insurance, double down, and card management. Implements object-oriented programming, polymorphism, smart pointers, web-sockets, concurrency, mutexes, HTTP controllers, and REST APIs.",
    tags: ["C++", "React", "Drogon Web Framework", "Concurrency", "Linux", "Git"],
    year: "2025",
